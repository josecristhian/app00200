...
import { Theme00100_Private_TopbarComponent } from '../topbar/topbar.component';

declare var $: any;

@Component({
	selector: 'theme00100-private-base',
	standalone: true,
	imports: [CommonModule, NgScrollbarModule, MenuToggleModule, WaicatoToastModule, WaicatoSpinnerModule, WaicatoTopBarModule, SidebarComponent, RouterModule, Theme00100_Private_TopbarComponent],
	providers: [],
...
export class Theme00100_Private_BaseComponent implements OnInit {
